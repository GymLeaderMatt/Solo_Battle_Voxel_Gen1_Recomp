...
StaticGeometry.EXCLUSION_FILE =
  "mod-derived/SOLO_BATTLE_VOXEL/static-cache-exclusions.tsv"
...
local function writeLedger()
  ...
  local text = table.concat({
    "# Solo Battle Voxel static-cache exclusion ledger",
  ...
  local ok = pcall(function()
    assert(fs.createDirectory("mod-derived/SOLO_BATTLE_VOXEL"))
